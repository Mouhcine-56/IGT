...
def test(V_NN):
    ...
    # Liste des temps à tester
    times = [0.0, 0.25, 0.5, 0.75, 1.0]

    with torch.no_grad():
        for t_val in times:
            # Créer le tenseur temps (N, 1)
            ...
            # Solution exacte
            # IMPORTANT : On s'assure que v_exact a la même forme que v_pred
            ...
            # Optionnel : Plot si on est en 1D ou slice 2D
